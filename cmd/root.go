...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.siderite.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".siderite" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".siderite")
	}
